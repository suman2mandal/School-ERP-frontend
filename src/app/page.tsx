      ...
      <>
        ...
        <div>
          ...
          <div className="bg-indigo-900 relative overflow-hidden">
                    ...
                    <div className="md:hidden">
                      <button className="text-white focus:outline-none">
                        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path x-show="open === true" d="M6 18L18 6M6 6L18 18" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </button>
                    </div>
            ...
            <div
                className="container h-screen w-screen mx-auto px-6 md:px-12 relative z-10 flex items-center py-24 xl:py-40">
