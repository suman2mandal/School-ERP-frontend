...
const StudentForm: React.FC = () => {
    ...
    const FORM_VALIDATION = Yup.object().shape({
        ...
        monthlyFees: Yup.number()
            ...
            .positive('Monthly Fees must be a positive number')
            .required('Monthly Fees is required'),
    ...
    const CalendarField: React.FC<CalendarFieldProps> = ({ field, form, ...otherProps }) => {
        const { values } = useFormikContext();

        // Set the initial date to date of birth
        const initialDate = values.dob || null;
        ...
        return (
            <div className="flex flex-col">
                <DateField
                    ...
                    helperText={form.errors[field.name] as string}
                    onError={Boolean(form.errors[field.name])}
                    // Set the initial value to date of birth
                    value={initialDate}
                    // You can add other props like maxDate or minDate to restrict future or past dates
                />
            ...
            >
                <Form>
                    ...
                    <SectionWrapper>
                        ...
                        <div className="flex flex-col">
                            <Field
                                ...
                                style={{width: "35ch"}}
                            />
                            <ErrorMessage name="monthlyFees" component="div" className="text-red-500" />
                        </div>
                    </SectionWrapper>
                    <SectionWrapper>
                        <div className="flex flex-col">
                    ...
                    <SectionWrapper>
                        ...
                        {/*    <ErrorMessage name="state" component="div" className="text-red-500" />*/}
                        {/*</div>*/}
                        <Field component={StateDropdown} name="state" label="State" />
